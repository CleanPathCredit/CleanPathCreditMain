...
export function Proof() {
  const testimonials = [
    ...
    },
    {
      ...
      quote: "I tried two other credit companies. Both used the same generic methods most places use. Clean Path actually looked at my reports, told me exactly what to fight and why. Night and day.",
      rating: 5,
    },
    {
      name: "James H.",
