        ...
        <section className="px-6 text-center max-w-4xl mx-auto mb-20">
          ...
          >
            ...
            <p className="text-lg font-medium text-zinc-900 md:text-xl max-w-3xl mx-auto">
              This isn’t basic credit repair. This is a strategic, AI-assisted audit and dispute system designed to remove inaccurate, unverifiable, and outdated items—fast.
            </p>
          </motion.div>
        </section>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="rounded-3xl border border-red-100 bg-red-50/50 p-8">
              ...
              <ul className="space-y-4">
                {[
                  "Send generic, copy-pasted dispute letters.",
            ...
            <div className="rounded-3xl border border-emerald-100 bg-emerald-50/50 p-8 shadow-sm">
              ...
              <ul className="space-y-4">
                {[
                  ...
                  "Apply legally backed dispute frameworks (FCRA, Section 609).",
        ...
        <section className="px-6 max-w-6xl mx-auto mb-24">
          <div className="grid md:grid-cols-3 gap-8">
            ...
            >
              ...
              <p className="text-zinc-600 leading-relaxed">
                We don't just ask nicely. We deploy aggressive, legally backed dispute strategies using federal laws like the FCRA and Section 609 to force deletions.
              </p>
            </motion.div>
