# Spanish Consumer-Facing One-Pager — B2B2C Handoff & Direct Funnel
...
**IMPORTANT — do not deploy or print until:**
  1. Texas CSO registration approved — number filled into the footer placeholder
  2. $10,000 surety bond placed — carrier filled into the footer placeholder
  3. A bilingual native speaker has read the copy and signed off (any odd phrasing in Spanish kills trust instantly with this avatar)
  4. Spanish-language CROA disclosures (Statement of Consumer Credit File Rights, contract, 3-day cancellation notice) are translated and ready to deliver — if you market in Spanish but disclose in English only, that's a UDAAP risk per CFPB guidance
...
**Lo que cambió en 2025-2026 — y por qué importa para tu familia.**

Por primera vez en más de 30 años, los pagos de tu **renta**, tu **luz**, tu **agua**, tu **internet**, y tus **biles mensuales** ahora sí cuentan para calificar para una hipoteca.
...
**Te preparamos para calificar para tu hipoteca — paso a paso, en español, en 60 a 90 días en promedio.**
...
### Section 4 — "Trabajamos con familias como la tuya" (the explicit acknowledgments)
...
### Section 5 — Trust block ("diferentes de las compañías de la radio")
...
### Footer (Spanish compliance)

Clean Path Credit — Restauración de Crédito y Preparación Hipotecaria.
...
Fianza (Surety Bond): **[CARRIER NAME, $10,000 — FILL IN AFTER PLACEMENT]**
...
## Optional Section (only for the printed leave-behind, NOT the landing page)

### English LO-handoff talking points

This section is for the LO who hands the printed page to a Latino buyer at the moment of credit denial. Either tear off and keep, or print on the back of the leave-behind. **Do not include on the landing-page version.**

**When to hand over the page:** Immediately after telling the buyer you can't approve their file due to credit. Don't wait, don't say you'll "send something later." The handoff happens at the moment of denial — that's when the buyer is most receptive to a real path forward.

**Talking points (for the LO):**

```
"I can't get you approved today on this file, but here's what I want to do.

I work with a partner who specializes specifically in helping families like yours — working families, often with cash income or ITIN, often first-time buyers — get to mortgage-ready in about 60 to 90 days. They're CROA-licensed, they don't charge anything upfront, everything is in Spanish if you prefer, and I get a weekly report on your progress so I know exactly when to bring you back to re-quote.

This page explains the program and gets you a free 15-minute call — no commitment.

When you're ready, you come back to me. I keep your file open. We close on a house together."
```

**Don't promise:**
- Specific timelines ("you'll be approved in 90 days")
- Specific score outcomes ("you'll be at a 680")
- That Clean Path "will get them approved" (you don't know that)
- Anything that sounds like a guarantee

**Do say:**
- "They specialize in your situation."
- "They're licensed and bonded under Texas law."
- "I keep your file open. When you're ready, we come back to it together."
...
**For the printed leave-behind version:**
- Single page, two-column, dark green Clean Path accent (#0a6e3d)
- Front: Sections 1-6 + Footer (Spanish only)
...
- This page is the destination for any Spanish-language video ad
- Each video should end with a verbal CTA: "Link en mi bio para una llamada gratis en español"
- Bio link points at this page (or at a `cleanpathcredit.com/r` shortlink that 301s to it for tracking)
- Don't deploy paid Meta traffic against this page until the Spanish CROA disclosures are translated and ready (per blocker #4 at the top of this doc)

**For the LO partnership integration:**
- When pitching Latino LOs (Bexar / Harris / North Texas Mexican-American mortgage broker offices), bring BOTH the English LO one-pager AND a stack of these consumer leave-behinds. Frame it: "You give the English page to your buyer. I give you the Spanish leave-behinds for the buyers who prefer Spanish, plus a handoff script in English so you know what to say."
- Latino LOs convert at 2-3x the rate of generic LOs on this offer because they actually have the buyers and have been frustrated by the lack of culturally-fit credit-repair partners.
